...
export const executeTx = async (NXV: NXV, NXVTx: NXVTransaction, signatures: NXVSignature[], overrides?: any): Promise<any> => {
    const signatureBytes = buildSignatureBytes(signatures);
    // console.log("signatureBytes", signatureBytes);
    return NXV.execTransaction(
        NXVTx.to,
        NXVTx.value,
        NXVTx.data,
        NXVTx.operation,
...
export const executeTxWithSigners = async (NXV: NXV, tx: NXVTransaction, signers: Signer[], overrides?: any) => {
    const NXVAddress = await NXV.getAddress();
