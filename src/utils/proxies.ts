...
import { NXVProxyFactory } from "../../typechain-types";

export const calculateProxyAddress = async (factory: NXVProxyFactory, singleton: string, inititalizer: string, nonce: number | string) => {
